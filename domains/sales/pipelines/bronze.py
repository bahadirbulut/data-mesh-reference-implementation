"""Sales Domain - Bronze Layer Pipeline

This script ingests raw sales order data from CSV files and loads it into the Bronze layer.
...
# Source: Landing zone where operational system drops CSV files
# Target: Bronze layer for raw data storage
source_path = "abfss://landing@<storage>.dfs.core.windows.net/sales/orders/"
